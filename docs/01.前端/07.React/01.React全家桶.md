...
![image-20240721003544519](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/202407210035736.png)
...
+useSearchParams 「新增的」︰获取问号传参信息，取到的结果是一个URLSearchParams对象+useParams r5中也有」:获取路径参数匹配的信息
-------
+ useMatch(pathname)>代替5中的useRouteMatch 「5中的这个Hook有用，可以基于params获取路径参数匹配的信息;但是在6中，这个Hook需要我们自己传递地址，而且params中也没有获取匹配的信息,用的就比较少了!!J i
