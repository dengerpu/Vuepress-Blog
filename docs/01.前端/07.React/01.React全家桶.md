...
![image-20240721235137538](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/202407212351802.png)
...
![image-20240717005835456](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/202407170058663.png)
...
![image-20240717003920708](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/202407170039874.png)
...
![image-20240721224013208](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/202407212240432.png)

### react-router-dom V6版本

[官方网址](https://reactrouter.com/en/main)

```shell
yarn add react-router-dom
```

![image-20240721003544519](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/202407212250620.png)

基于这种方式，在router5中，目标组件只要刷新，传递的信息就消失了；但是在router6中，这个**隐式传递的信息，却被保留下来了**。
